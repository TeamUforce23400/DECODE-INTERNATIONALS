...
public class RedMTI21ArtifactAuto extends CommandOpMode {
    ...
    private final Pose startPose = new Pose(112.586, 135, H0);
    private final Pose pose1 = new Pose(89, 78, Math.toRadians(67));
